  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      ...
      <ul class="list-group list-group-flush" style="width: 30vw;">
        <li class="list-group-item">TEST USER 1</li>
        <li class="list-group-item">Aditi Singh</li>
        <li class="list-group-item">Sakshi Rai</li>
        <li class="list-group-item">TEST USER 2</li>
        <li class="list-group-item">TEST USER 3</li>
      </ul>
...
<ul class="list-unstyled" style="padding: 3vw; border-radius: 2%; width: 90vw; margin-left: 5vw;">
  <li class="media">
    <img src="images/11.png" class="mr-3" alt="..." height="40vw;">
    <div class="media-body">
      <h5 class="mt-0 mb-1" style="font-weight: bold;color: #AA4E39"> Saniya Arora</h5>
      This book has been a great help for me. Contains some really good  examples that have made me think a lot. I would suggest this book to its readers.
    </div>
  </li>
  ...
  <li class="media my-4">
    <img src="images/11.png" class="mr-3" alt="..." height="40vw;">
    <div class="media-body">
      <h5 class="mt-0 mb-1" style="font-weight: bold;color: #AA4E39">Guna Shekhar </h5>
      Great experience for me, everyone should give it a try.
    </div>
  </li>
